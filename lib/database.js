exports.importCSV (csv, blessings, delimeter, newline, headers, importmode, callback) {
...
exports.exportCSV (csv, blessings, delimeter, newline, headers, callback) {
  jsonfile.readFile(blessings, function (err, obj) {
    if (err) {
      callback(err)
    } else {
...
exports.exportXML (xml, blessings, callback) {
  jsonfile.readFile(blessings, function (err, obj) {
    if (err) {
      callback(err)
    } else {
...
exports.createCalendar (year, blessings, callback) {
  jsonfile.readFile(blessings, function (err, obj) {
    if (err) {
      callback(err)
    } else {
